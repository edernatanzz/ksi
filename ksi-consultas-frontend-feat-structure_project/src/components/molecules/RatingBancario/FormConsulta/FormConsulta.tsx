...
import { PersonTypeSelector } from "@/components/molecules/RatingBancario/PersonTypeSelector/PersonTypeSelector"
import { DocumentoInput } from "@/components/atoms/RatingBancario/DocumentoInput/DocumentoInput"
...
export function FormularioConsulta({
  ...
  return (
      <Card className="bg-[#FFFCF9] h-full" data-testid={dataTestId}>
      <CardHeader 
        title={
      ...
      <CardContent className="space-y-4 md:space-y-6">
        ...
        <Button
          ...
          onClick={onSubmit}
          disabled={isLoading || !document.trim() || document.replace(/\D/g, '').length < 11}
