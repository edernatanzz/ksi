      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            onChange={(e) => onInputChange('dailyQueryLimit', parseInt(e.target.value))}
            disabled={isReadOnly}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Limite de Custo Mensal (R$)
          </label>
          <input
            type="number"
            value={formData.monthlyCostLimit}
            onChange={(e) => onInputChange('monthlyCostLimit', parseFloat(e.target.value))}
            disabled={isReadOnly}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none disabled:bg-gray-50"
            placeholder="500.00"
          />
